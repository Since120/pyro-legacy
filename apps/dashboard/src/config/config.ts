...
// export const DASHBOARD_API_URL = process.env.API_URL || "http://localhost:3333";

export const DASHBOARD_API_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3333';
