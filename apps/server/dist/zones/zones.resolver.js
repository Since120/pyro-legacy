...
__decorate([
    (0, graphql_1.Subscription)(() => zone_entity_1.Zone, {
        name: 'zoneCreated',
        filter: (payload) => Boolean(payload?.zoneCreated),
        resolve: (payload) => {
            if (payload && payload.zoneCreated) {
                return payload.zoneCreated;
            }
            throw new Error("Invalid payload received for zoneCreated");
        }
    }),
    __metadata("design:type", Function),
...
__decorate([
    (0, graphql_1.Subscription)(() => zone_entity_1.Zone, {
        name: 'zoneUpdated',
        filter: (payload) => Boolean(payload?.zoneUpdated),
        resolve: (payload) => {
            if (payload && payload.zoneUpdated) {
                return payload.zoneUpdated;
            }
            throw new Error("Invalid payload received for zoneUpdated");
        }
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
...
__decorate([
    (0, graphql_1.Subscription)(() => zone_entity_1.Zone, {
        name: 'zoneRemoved',
        filter: (payload) => Boolean(payload?.zoneRemoved),
        resolve: (payload) => {
            if (payload && payload.zoneRemoved) {
                return payload.zoneRemoved;
            }
            throw new Error("Invalid payload received for zoneRemoved");
        }
    }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
